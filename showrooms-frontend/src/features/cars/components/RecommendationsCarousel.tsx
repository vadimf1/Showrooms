...
import { getRecommendations } from "../api/cars.api";
...
const RecommendationsCarousel = ({ modelId, favs, onFav, onOpen }: Props) => {
  ...
  return (
    <section className="rec-section">
      <div className="rec-header">
        <h2 className="rec-title">Похожие автомобили</h2>
          ...
          return (
            <article key={car.id} className="rec-card" onClick={() => onOpen(car)}>
              ...
              <div className="rec-card-body">
                ...
                <div className="rec-card-price">{formatPriceFrom(car.price_from)}</div>
              </div>
            </article>
          );
        })}
